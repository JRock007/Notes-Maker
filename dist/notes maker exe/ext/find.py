    ...
    def replaceAll(self):
        ...
        if ((not self.find()) or len(unicode(self.parent.text.toPlainText())) == len(unicode(self.findField.toPlainText()))):
            ...
            while not reachedEnd:
                reachedEnd = self.find(len(unicode(self.replaceField.toPlainText())))
                founds += 1
            ...
            while founds > replaced:
                ...
                if self.find(len(unicode(self.replaceField.toPlainText()))):

                    self.lastStart = 0
                    self.find(len(unicode(self.replaceField.toPlainText())))
